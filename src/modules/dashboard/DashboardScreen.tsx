...
import { Search, Grid, List, ArrowLeft, X, Map } from 'lucide-react';
...
const DashboardScreen: React.FC = () => {
  ...
  const setViewModeAndResetMapFullscreen = (mode: 'grid' | 'list' | 'map') => {
    setViewMode(mode);
    if (mode !== 'map') {
  ...
  return (
    <div className="flex-1 overflow-auto bg-gray-50">
      <div className="p-4">
        ...
        {/* Filtro activo (mostrar solo si hay un filtro seleccionado y no estamos en vista de mapa) */}
        {activeKpiFilter && showStatisticsPanel && (
