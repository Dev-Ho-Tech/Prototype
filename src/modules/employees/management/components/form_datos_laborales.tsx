...
interface LaborDataFormProps {
  laboralData: LaborData;
  handleChange: (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
}

export const LaborDataForm: React.FC<LaborDataFormProps> = ({ laboralData, handleChange }) => {
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              value={laboralData.modalidadTiempo}
              onChange={handleChange}
        ...
        <div>
          ...
          <input
            ...
            value={laboralData.fechaInicialContrato}
            onChange={handleChange}
            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
        <div>
          ...
          <input
            ...
            value={laboralData.fechaFinalContrato}
            onChange={handleChange}
            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              value={laboralData.tipoPlanificacion}
              onChange={handleChange}
              className="w-full p-2 border border-gray-300 rounded-md appearance-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
